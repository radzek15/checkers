...
class AI:
    ...
    def minimax(self, current_board, is_maximizing, depth, turn):
        ...
        piece_moves = list(
            map(lambda piece: piece.get_moves(current_board) if piece.get_color() == turn else False, current_pieces))
    ...
    def get_move(self, current_board):
        ...
        jump_moves = list(filter(lambda mv: mv["move"]["eats_piece"] == True, possible_moves))
